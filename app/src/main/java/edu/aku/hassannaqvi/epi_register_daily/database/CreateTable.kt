...
object CreateTable {
    ...
    const val SQL_CREATE_VACCINESDATA = ("CREATE TABLE " + TableVaccinesData.TABLE_NAME + "("
            ...
            + TableVaccinesData.COLUMN_TT1 + " TEXT,"
            + TableVaccinesData.COLUMN_TT2 + " TEXT,"
            + TableVaccinesData.COLUMN_TT3 + " TEXT,"
            + TableVaccinesData.COLUMN_TT4 + " TEXT,"
            + TableVaccinesData.COLUMN_TT5 + " TEXT"
